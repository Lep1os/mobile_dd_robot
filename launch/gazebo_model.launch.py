...
def generate_launch_description():
    ...
    #this is the name of our package, at the same time this is the name of the folder that will be used to the define the paths
    ...
    spawnModeNode = Node(package='gazebo_ros', executable='spawn_entity.py',arguments=['-topic','robot_description','-entity', robotXacroName],output='screen')
